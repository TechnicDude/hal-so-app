...
enum _SliderTypes { material, adaptive }
...
class Slidercheck extends StatefulWidget {
  ...
  })  : _sliderTypes = _SliderTypes.material,
        assert(value != null),
        assert(min != null),
        assert(max != null),
        assert(min <= max),
  ...
  /// ignored: [label],_SeekbarState [inactiveColor], [semanticFormatterCallback].
  ///
  /// The target platform is based on the current [Theme]: [ThemeData.platform].
  const Slidercheck.adaptive({
    super.key,
    required this.value,
    required this.onChanged,
    this.onChangeStart,
    ...
    this.focusNode,
    this.autofocus = false,
  })  : _sliderTypes = _SliderTypes.adaptive,
        assert(value != null),
        assert(min != null),
        assert(max != null),
        assert(min <= max),
  ...
  final _SliderTypes _sliderTypes;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    //statis color add
    // properties.add(ColorProperty('staticColor', staticColor));
...
class _SlidercheckState extends State<Slidercheck>
  ...
  Widget build(BuildContext context) {
    ...
    // switch (widget._sliderTypes) {
    //   case _SliderTypes.material:

    //   case _SliderTypes.adaptive:
    //     {
    //       final ThemeData theme = Theme.of(context);
    //       assert(theme.platform != null);
    //       switch (theme.platform) {
  ...
  Widget _buildCupertinoSlider(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: CupertinoSlider(
        ...
        // staticColor: widget.activeColor,
      ),
    );
  }
...
class _RenderSlider extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  _RenderSlider({
    ...
    required this.onChangeStart,
    required this.onChangeEnd,
    required _SlidercheckState state,
  ...
  final _SlidercheckState _state;
